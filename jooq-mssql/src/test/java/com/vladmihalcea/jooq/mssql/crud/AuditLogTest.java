...
import com.vladmihalcea.jooq.mssql.schema.crud.high_performance_java_persistence.dbo.Routines;
import com.vladmihalcea.jooq.mssql.schema.crud.high_performance_java_persistence.dbo.routines.CleanUpAuditLogTable;
import com.vladmihalcea.jooq.mssql.schema.crud.high_performance_java_persistence.dbo.routines.CleanUpAuditLogTables;
import org.jooq.DSLContext;
import org.junit.Test;

import java.time.LocalDateTime;

import static com.vladmihalcea.jooq.mssql.schema.crud.high_performance_java_persistence.dbo.Tables.*;
...
public class AuditLogTest extends AbstractJOOQSQLServerSQLIntegrationTest {
    ...
    public void testCleanUpAuditLogTablePostComment() {
        ...
        doInJOOQ(sql -> {
            ...
            assertEquals(10_000, deletedRowCount);
        });
    }
