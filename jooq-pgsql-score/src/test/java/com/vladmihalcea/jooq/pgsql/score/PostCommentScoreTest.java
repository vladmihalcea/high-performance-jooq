...
import static com.vladmihalcea.jooq.pgsql.schema.score.Tables.POST_COMMENT;
...
public class PostCommentScoreTest extends AbstractJOOQPostgreSQLIntegrationTest {
    ...
    public void testJOOQ() {
        ...
        Long postId = 1L;
        int rank = 3;
        List<PostCommentScore> postCommentScores = PostCommentScoreRootTransformer.INSTANCE
            .transform(
